...
export default function Datenschutz(): React.ReactNode {
    return (
        <>
            ...
            <div className="contentblock mb-4 revealOnScroll" data-animation="fadeIn">
                <div className="introtext lead">
                    <p>Ich freuen mich sehr über Ihr Interesse an mir und meiner Website. Datenschutz hat einen
                        besonders
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-2-name-und-anschrift-des-fuer-die-verarbeitung-verantwortlichen">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>2. Name und Anschrift des für die Verarbeitung Verantwortlichen</small>
                    </h3>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-4-erfassung-von-allgemeinen-daten-und-informationen">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>4. Erfassung von allgemeinen Daten und Informationen</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-5-kontaktmoeglichkleiten-ueber-die-internetseite">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>5. Kontaktmöglichkleiten über die Internetseite</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-6-routinemaessige-loeschung-und-sperrung-von-personenbezogenen-daten">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>6. Routinemäßige Löschung und Sperrung von personenbezogenen Daten</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-7-rechte-der-betroffenen-person">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>7. Rechte der betroffenen Person</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <ul>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-8-rechtsgrundlage-der-verarbeitung">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>8. Rechtsgrundlage der Verarbeitung</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-9-berechtigte-interessen-an-der-verarbeitung-die-von-dem-verantwortlichen-oder-einem-dritten-verfolgt-werden">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-10-dauer-fuer-die-die-personenbezogenen-daten-gespeichert-werden">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>10. Dauer, für die die personenbezogenen Daten gespeichert werden</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-11-gesetzliche-oder-vertragliche-vorschriften-zur-bereitstellung-der-personenbezogenen-daten-erforderlichkeit-fuer-den-vertragsabschluss-verpflichtung-der-betroffenen-person-die-personenbezogenen-daten-bereitzustellen-moegliche-folgen-der-nichtbereitstellung">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>11. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen
            ...
            <div className="contentblock card card-material mb-4 revealOnScroll" data-animation="fadeIn"
                 id="block-12-bestehen-einer-automatisierten-entscheidungsfindung">
                <div className="card-body">
                    <h3 className="text-muted card-title">
                        <small>12. Bestehen einer automatisierten Entscheidungsfindung</small>
                    </h3>
                    <div className="card-text">
                        <div className="maintext">
                            <p>
